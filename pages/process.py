...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            This may be a frivolous and time consuming process (my report took 18 hours to execute), however, it gives incredible insight on the data being used. The pictures below help show the different utilities and information created by the report. Here are a few  examples of what Pandas Profiling Report generates:
