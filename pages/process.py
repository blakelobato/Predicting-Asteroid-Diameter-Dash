...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            html.Img(src='assets/pandas-profile.png', className='img-fluid')

            Here is an image of the variable descriptions from the report:
            html.Img(src='assets/variables.png', className='img-fluid')

            Here is an image of the correlations generated via the report:
            html.Img(src='assets/correlations.png', className='img-fluid')
            ...
            This step is somewhat self-explanatory. The profiling report showed that the target variable was crazy skewed. Using the IQR I was able to get a much cleaner distribution of 'diameter' so that the target data was as concise as possible. There are before and after pictures shown below.
             ...
             Here is an image of the Pandas Profiling Report:
             html.Img(src='assets/before-dist-diameter.png', className='img-fluid')

            Here is an image of the variable descriptions from the report:
            html.Img(src='assets/after-dist-diameter.png', className='img-fluid')
            ...
            html.Img(src='assets/random-forest-regressor.png', className='img-fluid')


            ### Step 6. Model Results:
            The results and errors are shown for each of the five models in the image below:
            html.Img(src='assets/results.png', className='img-fluid')
