...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            ![Pandas Profile Report](https://github.com/blakelobato/Predicting-Asteroid-Diameter-Dash/blob/master/Images/pandas-profile.png)

            Here is an image of the variable descriptions from the report:
            ![Variables](https://github.com/blakelobato/Predicting-Asteroid-Diameter-Dash/blob/master/Images/variables.png)

            Here is an image of the correlations generated via the report:
            ![Correlation](https://github.com/blakelobato/Predicting-Asteroid-Diameter-Dash/blob/master/Images/correlations.png)
            ...
            This step is somewhat self-explanatory. The profiling report showed that the target variable was crazy skewed. Using the IQR I was able to get a much cleaner distribution of 'diameter' so that the target data was as concise as possible. There are before and after pictures shown below.
             ...
             Here is an image of the Pandas Profiling Report:
            ![Before Outlier Removal](https://github.com/blakelobato/Predicting-Asteroid-Diameter-Dash/blob/master/Images/before-dist-diameter.png)

            Here is an image of the variable descriptions from the report:
            ![After Outlier Removal](/https://github.com/blakelobato/Predicting-Asteroid-Diameter-Dash/blob/master/Images/after-dist-diameter.png)
